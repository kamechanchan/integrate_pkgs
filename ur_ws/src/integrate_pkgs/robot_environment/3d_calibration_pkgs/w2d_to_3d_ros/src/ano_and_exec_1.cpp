...
void Ano_and_Exec::InputCallback(const denso_msgs::object_kiriwakeConstPtr &kiri_mes)
{
    ...
    denso_msgs::object_kiriwake kiri = *kiri_mes;
...
void Ano_and_Exec::paramter_set_bara(denso_msgs::object_kiriwake mes)
{
