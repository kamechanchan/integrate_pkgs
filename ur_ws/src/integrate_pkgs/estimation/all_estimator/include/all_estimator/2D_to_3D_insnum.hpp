...
public:
    ...
    bool bridge(denso_srvs::input_bridge::Request &req, denso_srvs::input_bridge::Response &res);
...
private:
    ...
    denso_msgs::yolo_bridge msg_data_;
    pcl::PointCloud<pcl::PointXYZ> trans_cloud_;
    sensor_msgs::PointCloud2 cloud_msgs_;
    // denso_srvs::bounding srv_;
    denso_srvs::input_bridge srv_;
    // denso_srvs::bounding segment_data_;
};