...
#include <denso_srvs/input_bridge_multi.h>
...
public:
    ...
    bool bridge(denso_srvs::input_bridge_multi::Request &req, denso_srvs::input_bridge_multi::Response &res);
...
private:
    ...
    denso_srvs::input_bridge_multi srv_;
    int Bbox_num_;
};