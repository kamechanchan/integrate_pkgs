...
class TrainOptions_temmat():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_mode', choices={"instance_segmentation", "pose_estimation","semantic_segmentation", "temmat"}, default='pose_estimation')
