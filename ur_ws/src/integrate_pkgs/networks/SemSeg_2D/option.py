...
from encoding.nn.customize import JPU
...
class Options():
    def __init__(self):
        ...
        # checking point
        parser.add_argument('--resume', type=str, default="/home/ericlab/ros_package/integrate_ws/src/integrate_pkgs/networks/SemSeg_2D/weights/model_best.pth.tar",
